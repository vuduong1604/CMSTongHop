import { _decorator, Component, Node, EditBox, assetManager, SpriteFrame, Texture2D, Sprite, AudioSource, AudioClip, ImageAsset, v3, v2 } from 'cc';
...
@ccclass('ItemGamePhudong')
export class ItemGamePhudong extends Component {
    ...
    GetData() {
        ...
        itemdata.GameIdMini = IDGame.GamePhudong;
    ...
    async LoadData(data) {
        ...
        console.log("Game phu dong Data =>", JSON.parse(data));
        ...
        for(var i = 0; i < dataObj.answer.length;i++){
            // console.log(i,dataObj.answer[i].Sound);
